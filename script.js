window.onload = function() {
    ...
    // 获取响应时间
    var responseTime = window.performance.timing.responseEnd - window.performance.timing.requestStart;
    document.getElementById("response-time").innerHTML = "响应时间：" + responseTime + "毫秒";
    document.getElementById("load-time").innerHTML = "加载时间：" + loadTime / 1000 + "秒";
};
...
function askQuestion(title, question, correctAnswer) {
    Swal.fire({
        title: title,
        html: question,
        input: 'text',
